...
class Rebuild(object):
  ...
  '''
    ...
    '''
        ...
        update_sql = "UPDATE {table_name} SET {field_name} = {to_table_id} WHERE {where_field} = {from_table_id}".format(
...
if __name__ == '__main__':
    ...
    ##########################################################################
    # 获得商品的游标
    goods_sql = "SELECT goods_id FROM goods_1"
    ...
    ##########################################################################
    # 获得订单商品的游标
    order_goods_sql = "SELECT order_goods_id FROM order_goods_1"
